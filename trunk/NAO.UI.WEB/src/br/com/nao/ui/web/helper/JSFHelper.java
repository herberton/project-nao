...
import br.com.nao.exception.NAOException;
...
public class JSFHelper implements Serializable {
	...
	public static String getDefaultParameters() {
		return ConfigurationHelper.UI_WEB_URL_DEFAULT_PARAMETERS;
	}
	...
	public static void setLocale(Locale locale){
		JSFHelper.getUIViewRoot().setLocale(locale);
	}
	...
	@SafeVarargs
	public static <T extends NAOException> void addMessage(final T...eArray){
		for (NAOException e : eArray) {
			JSFHelper.addMessage(FacesMessage.SEVERITY_ERROR, e.getExceptionKey(), e.getDetailPropertyKey());
		}
	}
	@SafeVarargs
	public static void addMessage(String clientId, NAOException...eArray){
		for (NAOException e : eArray) {
			JSFHelper.addMessage(clientId, FacesMessage.SEVERITY_ERROR, e.getExceptionKey(), e.getDetailPropertyKey());
		}
	}
	...
	public static String dateLanguageFormatter(){
		String displayLanguage = getLocale().getLanguage(); 
		if(displayLanguage.equalsIgnoreCase("pt_br")){
			return "dd/MM/yyyy";
