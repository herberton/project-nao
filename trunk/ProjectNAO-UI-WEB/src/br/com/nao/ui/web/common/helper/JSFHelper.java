...
import br.com.nao.helper.exception.EmptyParameterException;
...
public class JSFHelper implements Serializable {
	...
	public static void showMessage(String clientId, Message message) {
		try {
			JSFHelper.getFacesContext().addMessage(clientId, JSFHelper.getFacesMessage(message));
		} catch (NAOException e) {
			JSFHelper.showMessage(clientId, e);
		}
	}
	public static void showMessage(String clientId, IMessenger messenger) {
		JSFHelper.showMessage(clientId, messenger.toMessage());
	}
	public static FacesMessage getFacesMessage(Message message) throws NAOException {
...
//	@SafeVarargs
//	public static <T extends NAOException> void addMessage(final T...exceptionArray){
//		for (NAOException exception : exceptionArray) {
//			JSFHelper.addMessage(FacesMessage.SEVERITY_ERROR, exception.getExceptionKey(), exception.getDetailPropertyKey());
//		}
//	}
//	@SafeVarargs
//	public static void addMessage(String clientId, NAOException...exceptionArray){
//		for (NAOException exception : exceptionArray) {
